...
class SchedulesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create schedule" do
    assert_difference('Schedule.count') do
      post schedules_url, params: { schedule: { body: @schedule.body, day: @schedule.day, title: @schedule.title } }
    end
  ...
  test "should update schedule" do
    patch schedule_url(@schedule), params: { schedule: { body: @schedule.body, day: @schedule.day, title: @schedule.title } }
